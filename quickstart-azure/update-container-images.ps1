...
$templateDir = Split-Path -Parent $scriptDir  # Go up to quickstart-azure parent (infra/azure in full path context)
$mainTemplate = Join-Path $scriptDir ".." ".." "infra" "azure" "main.bicep"
$parameterFile = Join-Path $scriptDir ".." ".." "infra" "azure" "parameters" "profile-$Profile.json"
...
Write-Host ""d with all necessary parameters
    $deploymentParams = @{
